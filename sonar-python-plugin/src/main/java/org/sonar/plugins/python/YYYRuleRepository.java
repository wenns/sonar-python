...
public class YYYRuleRepository implements RulesDefinition {

  public static final String REPOSITORY_NAME = "YYY";
  public static final String REPOSITORY_KEY = REPOSITORY_NAME;

  private static final String RULES_FILE = "/org/sonar/plugins/python/yyy/rules.xml";
  private static final String SQALE_FILE = "/com/sonar/sqale/python-model.xml";
  private final RulesDefinitionXmlLoader xmlLoader;

  public YYYRuleRepository(RulesDefinitionXmlLoader xmlLoader) {
